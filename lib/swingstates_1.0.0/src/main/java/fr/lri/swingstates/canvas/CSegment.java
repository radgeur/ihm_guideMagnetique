...
public class CSegment extends CRectangularShape {
	...
	public CSegment setPoints (double x1, double y1, double x2, double y2) {
		((Line2D)getShape()).setLine(x1, y1, x2, y2);
		repaint();
		return this;
	}
	...
	*/
	...
	public CRectangularShape setDiagonal (double x1, double y1, double x2, double y2) {
		...
		Point2D point1 = ((Line2D)getShape()).getP1();
		Point2D point2 = ((Line2D)getShape()).getP2();
		...
		((Line2D)getShape()).setLine(point1, point2);
		repaint();
		return this;
	}
	...
	public double getLength() {
		return (((Line2D)getShape()).getP1()).distance(((Line2D)getShape()).getP2());
	}
}
