 ...
 */
public class ReleaseOnJTag extends MouseOnJTag {
	 ...
	 */
	public ReleaseOnJTag(String tagName, int button) {
	 ...
	 * @param button The button of the mouse event: NOBUTTON, BUTTON1, BUTTON2 or BUTTON3
	 */
	public ReleaseOnJTag(Class tagClass, int button) {
	 ...
	 * @param button The button of the mouse event: NOBUTTON, BUTTON1, BUTTON2 or BUTTON3
	 */
	public ReleaseOnJTag(JTag tag, int button) {
		super(tag,  button);
	}
	 ...
	 */
	public ReleaseOnJTag(String tagName, int button, int modifier) {
	 ...
	 * @param modifier The modifier: NOMODIFIER, CONTROL, ALT, SHIFT, ALT_CONTROL, CONTROL_SHIFT, ALT_SHIFT or ALT_CONTROL_SHIFT
	 */
	public ReleaseOnJTag(Class tagClass, int button, int modifier) {
	 ...
	 * @param modifier The modifier: NOMODIFIER, CONTROL, ALT, SHIFT, ALT_CONTROL, CONTROL_SHIFT, ALT_SHIFT or ALT_CONTROL_SHIFT
	 */
	public ReleaseOnJTag(JTag tag, int button, int modifier) {
	 ...
	 */
	public ReleaseOnJTag(String tagName, int button, String outState) {
	 ...
	 * @param outState The name of the output state
	 */
	public ReleaseOnJTag(Class tagClass, int button, String outState) {
	 ...
	 * @param outState The name of the output state
	 */
	public ReleaseOnJTag(JTag tag, int button, String outState) {
	 ...
	 * @param outState The name of the output state
	 */
	public ReleaseOnJTag(String tagName, int button, int modifier, String outState) {
	 ...
	 * @param outState The name of the output state
	 */
	public ReleaseOnJTag(Class tagClass, int button, int modifier, String outState) {
	 ...
	 * @param outState The name of the output state
	 */
	public ReleaseOnJTag(JTag tag, int button, int modifier, String outState) {
