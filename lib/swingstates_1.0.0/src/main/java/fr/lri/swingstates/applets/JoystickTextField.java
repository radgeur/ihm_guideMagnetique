...
import fr.lri.swingstates.sm.jtransitions.PressOnJTag;
...
class JoystickTextField {
	...
	JStateMachine smText = new JStateMachine() {
		...
		public State out = new State() {
			...
			Transition enter = new EnterOnJTag("javax.swing.JTextField", ">> in") {
				public void action() {
		...
		public State in = new State() {
			...
			Transition leave = new LeaveOnJTag("javax.swing.JTextField", ">> out") {
				public void action() {
			...
			Transition press = new PressOnJTag("javax.swing.JTextField", BUTTON1, ">> control") {
				public void action() {
...
//					Point2D pt = getPointInMainContainer();
			...
			Transition releaseIn = new ReleaseOnJTag("javax.swing.JTextField", BUTTON1, ">> in") { };
