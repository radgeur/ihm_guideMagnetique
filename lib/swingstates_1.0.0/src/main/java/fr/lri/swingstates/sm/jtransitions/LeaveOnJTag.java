 ...
 */
public class LeaveOnJTag extends MouseOnJTag {
	 ...
	 */
	public LeaveOnJTag(String tagName) {
	 ...
	 */
	public LeaveOnJTag(Class tagClass) {
	 ...
	 */
	public LeaveOnJTag(String tagName, int modifier) {
	 ...
	 * @param modifier The modifier: NOMODIFIER, CONTROL, ALT, SHIFT, ALT_CONTROL, CONTROL_SHIFT, ALT_SHIFT or ALT_CONTROL_SHIFT
	 */
	public LeaveOnJTag(Class tagClass, int modifier) {
	 ...
	 * @param modifier The modifier: NOMODIFIER, CONTROL, ALT, SHIFT, ALT_CONTROL, CONTROL_SHIFT, ALT_SHIFT or ALT_CONTROL_SHIFT
	 */
	public LeaveOnJTag(JTag tag, int modifier) {
	 ...
	 */
	public LeaveOnJTag(String tagName, String outState) {
	 ...
	 * @param outState The name of the output state
	 */
	public LeaveOnJTag(Class tagClass, String outState) {
	 ...
	 * @param outState The name of the output state
	 */
	public LeaveOnJTag(JTag tag, String outState) {
	 ...
	 * @param outState The name of the output state
	 */
	public LeaveOnJTag(String tagName, int modifier, String outState) {
	 ...
	 * @param outState The name of the output state
	 */
	public LeaveOnJTag(Class tagClass, int modifier, String outState) {
	 ...
	 * @param outState The name of the output state
	 */
	public LeaveOnJTag(JTag tag, int modifier, String outState) {
